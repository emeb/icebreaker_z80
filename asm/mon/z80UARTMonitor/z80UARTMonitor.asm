...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	INC HL
	JP display
L1:	CP $7F		; backspace: decrement and display
	JP NZ, L2
	DEC HL
	JP display
...
chkchar:
		IN A, (ACIA_LSR)
		BIT 1, A			; bit 1 is set when data present
		JP NZ, gotchar
		LD A, $FF
		RET
gotchar:
...
oloop:	
		IN A, (ACIA_LSR)	; read LSR
		BIT 0, A	; bit 0 is transmitter empty
		JP Z, oloop
		POP AF
		RET
